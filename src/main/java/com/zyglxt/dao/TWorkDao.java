...
public class TWorkDao {
    ...
    public List<Work> getWorkData(String teacher) throws SQLException {
        Connection connection=null;
        PreparedStatement statement=null;
        String sql="select * from work where teacher=?";
        ...
        try {
            ...
            while(rs.next()){
                ...
                Work work =new Work(workname,coursename,teacher1,worktype,gradetype,grade,reviewmethod,deadline,type,file,student1);
                workList.add(work);
            }

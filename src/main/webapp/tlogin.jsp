...
<div class="login_div">
    ...
    <button class="student_login" id="btn1"><a href="login.jsp">学生登录</a></button>
    <button class="teacher_login" id="btn2"><a href="tlogin.jsp" class="active">教师登录</a></button>
    <div class="hr"></div>

    <div class="login_form_div">
        <div class="form_div">
            <form action="TLogin" method="post" accept-charset="UTF-8">

...
<head>
    ...
    <style>
        * {
        ...
        .time:hover,.textur1:hover,.textur2:hover {
...
<div class="left-nav">
    <h1>作业管理系统</h1>
    <ul class="nav-ul">
        <li class="left_nav_active"><a href="#" >首页</a></li>
...
<div class="box" id="box2">
    ...
    <a href="tcourse.jsp"><button class="box2_button2">></button></a>
</div>
...
<div class="box" id="box3">
    <div class="time">
        <h1><%=session.getAttribute("username")%>老师，<%=time%></h1>

    </div>
    <img class="textur1" src="./picture/小程序.png" alt="">
    <img class="textur2" src="./picture/公众号.png" alt="">
